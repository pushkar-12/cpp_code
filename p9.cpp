...
typedef multiset<ll> MSETI;
 ...
 const int N=2*ee5;
 int o=1,e=1;
 int evenst[N],oddst[N],dep[N],firstchild[N],pos[N],ODD[N],EVEN[N],val[N];
vvi g(N);
void dfs(int v,int p)
{
	if(dep[v]%2){pos[v]=o;o++;ODD[pos[v]]=val[v];}
	else {pos[v]=e;e++;EVEN[pos[v]]=val[v];}
...
int main()
{
	...
	int n,m;cin>>n>>m;rep(i,n)cin>>val[i];
	rep(i,n-1)
